...
def budget_check(pname, time):
    def check_task():
        ...
        if ybudget_list.count() == 0 or is_single_project:
            ...
            logger.info(budget_data)
            logger.info(ann_budget)
